  ...
  <div class="cart">
    ...
    <div v-if="isLogin && cartList.length > 0">
      ...
      <div class="cart-title">
        ...
        <span class="edit" @click="isEidt = !isEidt">
          <van-icon name="edit" />
          编辑
        </span>
      </div>
      ...
      <div class="cart-list">
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          <van-checkbox @click="toggleCheck(items.goods_id)" :value="item.isChecked"></van-checkbox>
          <div class="show">
          ...
          <div class="info">
            ...
            <span class="bottom">
              ...
              <div class="count-box">
                <!-- 既希望保留原本的形参，有需要通过调用函数传参，则使用箭头函数包装 -->
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          ...
          <div v-if="!isEidt" class="goPay" :class="{ disabled: selCount === 0}" >结算({{ selCount }})</div>
